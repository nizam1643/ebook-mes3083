      ...
      <div class="card-body">
            ...
            <form action="{{ route('admin.package.update', $package->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input id="name" name="name" type="text" class="form-control" aria-describedby="nameHelpBlock" value="{{ $package->name }}" required="required"> 
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input id="sub_name" name="sub_name" type="text" class="form-control" value="{{ $package->sub_name }}" required="required" aria-describedby="sub_nameHelpBlock"> 
                    @error('sub_name')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input id="price" name="price" type="number" class="form-control" value="{{ $package->price }}" aria-describedby="priceHelpBlock" required="required"> 
                    @error('price')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input id="task" name="task" type="number" class="form-control" value="{{ $package->task }}" aria-describedby="taskHelpBlock" required="required"> 
                    @error('task')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div> 
